        ...
        <form action="#" method="POST">
          ...
          <div class="form-box">
            ...
            <div class="remember">
              ...
              <span><a href="forgot.php">Olvide mi clave</a></span>
            </div>
          ...
          <input type="submit" name="login" id="submit" value="Entrar" class="button">

          <div class="links">
            No tienes una cuenta? <a href="signup.php">Registrarse</a>
          </div>
